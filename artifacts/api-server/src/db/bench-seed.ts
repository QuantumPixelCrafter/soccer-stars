/**
 * Bench Player Pool — 70 famous players, rating range 60–78
 * These are the players drawn from when granting a Free 11-Player Starter Pack.
 * Each has a specific tactical_position used for squad slot assignment.
 * Ratings intentionally below the Gold Card pool (which starts at 62).
 */
...
// position field mirrors tactical_position for bench pool players
export const BENCH_PLAYERS: BenchPlayer[] = [
  ...
  { name: "Wojciech Szczęsny",     initials: "WS",  tactical_position: "GK", country: "Poland",       club: "Barcelona",           is_gk: true,  fks: 74, pks: 74, overall: 74 },
  ...
  { name: "Milan Škriniar",        initials: "MŠ",  tactical_position: "CB", country: "Slovakia",     club: "PSG",                 is_gk: false, fk: 64, pk: 60, overall: 76 },
  ...
  { name: "Rodri",                 initials: "Rod", tactical_position: "CDM", country: "Spain",       club: "Manchester City",     is_gk: false, fk: 76, pk: 70, overall: 78 },
  ...
  { name: "Dušan Vlahović",        initials: "DV",  tactical_position: "ST", country: "Serbia",       club: "Juventus",            is_gk: false, fk: 74, pk: 86, overall: 76 },
  ...
  { name: "Wilfried Zaha",         initials: "WZ",  tactical_position: "RW", country: "Ivory Coast",  club: "Galatasaray",         is_gk: false, fk: 72, pk: 65, overall: 70 },
  { name: "Ousmane Dembélé",       initials: "OD",  tactical_position: "RW", country: "France",       club: "PSG",                 is_gk: false, fk: 75, pk: 70, overall: 77 },

  // ── Left Wingers (8) ──────────────────────────────────────────────────────
  { name: "Khvicha Kvaratskhelia", initials: "KKv", tactical_position: "LW", country: "Georgia",      club: "PSG",                 is_gk: false, fk: 80, pk: 76, overall: 78 },
  ...
  { name: "Ansu Fati",             initials: "AF",  tactical_position: "LW", country: "Spain",        club: "Sporting CP",         is_gk: false, fk: 72, pk: 68, overall: 70 },
